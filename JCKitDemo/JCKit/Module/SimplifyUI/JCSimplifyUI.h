...
FOUNDATION_EXPORT NSString * const JCTabBarControllerChildControllerName;           // 子控制器名
FOUNDATION_EXPORT NSString * const JCTabBarControllerChildControllerClass;          // 子控件类
FOUNDATION_EXPORT NSString * const JCTabBarControllerChildControllerTitle;          // 标题
FOUNDATION_EXPORT NSString * const JCTabBarControllerChildControllerNormalImage;    // 默认图片
FOUNDATION_EXPORT NSString * const JCTabBarControllerChildControllerSelectedImage;  // 选中图片
